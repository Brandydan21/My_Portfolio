...
<head>
	<meta charset="utf-8"/>
	<meta name="description" content="Quiz marking"/>
	<meta name="keywords"    content="marking, attempt, quiz"/>
	<meta name="author" content="Amber Biezen"/>
	<title>Marking Quiz</title>
</head>
<body>
	<h1>Quiz Attempt</h1>
	<!-- cleaning up -->
			...
			if ($previousAttempt == 2) {
				...
				if (!$insertResults) {
				    ...
				    echo "<p class='ok'>Successfully added attempt</p>
							...
							Attempts: $attempts / 2</p>";
					if ($attempts == 1) {
						echo "<a href=quiz.php>Attempt again</a>";
					}
				}
			}
